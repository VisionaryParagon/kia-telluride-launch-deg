...
@Component({
  selector: 'app-switched-on-main',
  templateUrl: './switched-on-main.component.html',
  styleUrls: ['./switched-on-main.component.scss'],
  animations: [ FadeAnimation, TopDownAnimation ]
})
export class SwitchedOnMainComponent implements OnInit {
  user: User = this.userService.getCurrentUser();
  userId: string = this.cookieService.get('userId');
  quizName = 'SwitchedON Quiz';
  quizData: QuizData;
  hasAnswers = false;
  error = '';
